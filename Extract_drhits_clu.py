...
class Extract:
    ...
    def read(self, N=None):
       ...
       # pt_reco = ak.sum(arrs["pt"],axis=-1)
        ...
        clu_cond = Rechit_frac>0

        HitsX = HitsX[clu_cond]
        HitsY=HitsY[clu_cond]
        HitsZ = HitsZ[clu_cond]
        HitsEn = HitsEn[clu_cond]
        ...
        #lf = localfeat(HitsEta,HitsPhi,HitsEn0)
        #df = detfeat(HitsiEta,HitsiPhi,HitsEn0)
