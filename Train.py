...
class Train:
    ...
    def train(self):
        ...
        trainer = GNNTrainer(
            output_dir=self.folder, device=self.device, acc_rate=self.acc_rate
        )
        ...
        with open(summary_file, "wb") as f:
            pickle.dump(self.trainSummary, f, protocol=5)
